...
function updateWonderCost(){
    ...
    preciousGoldCost = 1 * floor1Price;
    preciousActivateGemCost = 1 * floor1Price;
    preciousActivateSilverCost = 1 * floor1Price;
    preciousActivateGoldCost = 1 * floor1Price;
    energeticWoodCost = 1 * floor1Price;
    energeticCharcoalCost = 1 * floor1Price;
    energeticUraniumCost = 1 * floor1Price;
    energeticActivateWoodCost = 1 * floor1Price;
    energeticActivateCharcoalCost = 1 * floor1Price;
    energeticActivateUraniumCost = 1 * floor1Price;
    techSiliconCost = 1 * floor1Price;
    techGoldCost = 1 * floor1Price;
    techGemCost = 1 * floor1Price;
    techActivateSiliconCost = 1 * floor1Price;
    techActivateGoldCost = 1 * floor1Price;
    techActivateGemCost = 1 * floor1Price;
    meteoriteMeteoriteCost = 1 * floor1Price;
    meteoriteIceCost = 1 * floor1Price;
    meteoriteSiliconCost = 1 * floor1Price;
    meteoriteActivateMeteoriteCost = 1 * floor1Price;
    meteoriteActivateIceCost = 1 * floor1Price;
    meteoriteActivateSiliconCost = 1 * floor1Price;

    commsWonderGoldCost = 1 * floor23Price;
    commsWonderSiliconCost = 1 * floor23Price;
    commsWonderIceCost = 1 * floor23Price;
    rocketWonderLunariteCost = 1 * floor23Price;
    rocketWonderTitaniumCost = 1 * floor23Price;
    rocketWonderMetalCost = 1 * floor23Price;
    antimatterWonderUraniumCost = 1 * floor23Price;
    antimatterWonderLavaCost = 1 * floor23Price;
    antimatterWonderOilCost = 1 * floor23Price;
    antimatterWonderMethaneCost = 1 * floor23Price;
    portalMeteoriteCost = 1 * floor23Price;
    portalHeliumCost = 1 * floor23Price;
    portalSiliconCost = 1 * floor23Price;
    stargateWonderPlasmaCost = 1 * floor23Price;
    stargateWonderSiliconCost = 1 * floor23Price;
    stargateWonderMeteoriteCost = 1 * floor23Price;
}
